class FAShotgunFireBProj extends LAWProj;
...
defaultproperties
{
     ExplosionEmitter=Class'MutSR.FAShotgunFireBProjExplosion'
     FlameTrailEmitterClass=Class'MutSR.FAShotgunFireBProjTrail'
