...
//=============================================================================
class M4203CAssaultRifle extends M4AssaultRifle
	config(user);
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'MutSR.M4203CBulletFire'
     FireModeClass(1)=Class'MutSR.M203XFire'
     Description="An assault rifle with an attached grenade launcher."
     Priority=190
     GroupOffset=8
     PickupClass=Class'MutSR.M4203CPickup'
     AttachmentClass=Class'MutSR.M4203CAttachment'
     ItemName="M4 203AssaultRifle"
}
