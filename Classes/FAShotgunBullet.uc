...
//=============================================================================
class FAShotgunBullet extends Projectile;
...
defaultproperties
{
     ...
     MaxPenetrations=2
     PenDamageReduction=0.350000
     HeadShotDamageMult=1.550000
     ImpactEffect=Class'ROEffects.ROBulletHitEffect'
     ExplosionEmitter=Class'MutSR.FAShotgunImpactEffect'
     Speed=3500.000000
     bSwitchToZeroCollision=True
     Damage=18.000000
     DamageRadius=10.000000
     MomentumTransfer=60000.000000
     MyDamageType=Class'MutSR.DamTypeFAShotgun'
     ExplosionDecal=Class'MutSR.FAShotgunDecal'
