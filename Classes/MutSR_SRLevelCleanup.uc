Class MutSR_SRLevelCleanup extends Interaction;
...
static final function AddSafeCleanup( PlayerController PC, optional string NextURL )
{
	...
	for( i=(PC.Player.LocalInteractions.Length-1); i>=0; --i )
		...
		{
			MutSR_SRLevelCleanup(PC.Player.LocalInteractions[i]).SwitchToURL = NextURL;
			return;
		}
	C = new(None) Class'MutSR_SRLevelCleanup';
